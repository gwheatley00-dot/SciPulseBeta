...
def main():
    ...
    query = st.text_input("Search research topics", value=st.session_state.get("query", ""), placeholder="e.g. gut microbiome, CRISPR, sleep deprivation...")
    ...
    if st.button("Search") and query:
        ...
        st.markdown("<div class=\"no-results\">Enter a topic above or pick one from the sidebar.</div>", unsafe_allow_html=True)
